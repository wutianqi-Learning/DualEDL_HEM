...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='flare22', name='resunet-40k'),
        define_metric_cfg=dict(mDice='max'))
]
visualizer = dict(type=SegLocalVisualizer,
                  vis_backends=vis_backends,
                  name='visualizer')
work_dir = '../working_flare22/res2_unet/lr_0002-ReduceOnPlateauLR_50epoch-evidence-MSE-daul_weight_softlplus-relu-CEM2-ML-reverse'
