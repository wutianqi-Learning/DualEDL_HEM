...
if __name__ == '__main__':
    ...
    root_path = './'  # original file
    img_suffix = '.jpg'
    seg_map_suffix = '.png'
    save_img_suffix = '.png'
    save_seg_map_suffix = '.png'

    train_imgs = glob.glob('./ISIC-2017_Training_Data/*' + img_suffix)
    train_masks = glob.glob('./ISIC-2017_Training_Part1_GroundTruth/*' +
                            seg_map_suffix)

    val_imgs = glob.glob('./ISIC-2017_Validation_Data/*' + img_suffix)
    val_masks = glob.glob('./ISIC-2017_Validation_Part1_GroundTruth/*' +
                          seg_map_suffix)

    test_imgs = glob.glob('./ISIC-2017_Test_v2_Data/*' + img_suffix)
    test_masks = glob.glob('./ISIC-2017_Test_v2_Part1_GroundTruth/*' +
                           seg_map_suffix)
