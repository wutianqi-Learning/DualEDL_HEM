...
class EvidenceLoss(BaseWeightedLoss):
    ...
    def edl_loss(self, func, y, alpha, annealing_coef, target, weight=None):
    ...
    def _forward(self, evidence, target, **kwargs):
        """Forward function.
        Args:
        ...
        if self.loss_type == 'mse':
            ...
            results = self.edl_loss(torch.digamma, y, alpha, annealing_coef, target, weight=weight)
