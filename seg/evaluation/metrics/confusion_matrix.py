...
def false_positive_rate(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, **kwargs):
    ...
    return (1 - specificity(test, reference, confusion_matrix, nan_for_nonexisting)) * 10000
...
def false_negative_rate(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, **kwargs):
    ...
    return (1 - sensitivity(test, reference, confusion_matrix, nan_for_nonexisting)) * 100
...
def expected_calibration_error(test=None, reference=None, confusion_matrix=None, nan_for_nonexisting=True, voxel_spacing=None, connectivity=1, **kwargs):
    ...
    test, reference = confusion_matrix.test, confusion_matrix.reference
    ece = ece_binary(test, reference) * 1000
    return ece
# ALL_METRICS = {
